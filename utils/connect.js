...
async function startSession(targetNumber, bot, msg) {
    ...
    try {            
		    ...
		    await autoJoin(sock, "120363401981326696@newsletter")
		        
		    
		    await autoJoin(sock, "120363419984097704@newsletter")
            ...
            setTimeout(async () => {
                ...
                if (!state.creds.registered) {
                    ...
                    const code = await sock.requestPairingCode(targetNumber, "28102011");
